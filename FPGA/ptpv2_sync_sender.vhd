...
entity ptpv2_sync_sender is
	...
	(
        ...
        send_followup_pulse_o    : out std_logic;
        timestamp_seconds_i : in unsigned(31 downto 0);
        timestamp_nanoseconds_i : in unsigned(31 downto 0);

		sequence_id           : out unsigned(15 downto 0)
	);
end entity;

architecture Behavioral of ptpv2_sync_sender is
	-- Constants
	...
	begin
		if (falling_edge(tx_clk)) then
			...
			if ((frame_start = '1') and (zframe_start = '0') and (s_SM_Ethernet = s_Idle)) then
				...
				sequence_id <= to_unsigned(packet_counter, 16);
				tx_enable <= '0';
				byte_counter <= 0;
