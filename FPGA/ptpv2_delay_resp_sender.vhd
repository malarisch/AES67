...
entity ptpv2_delay_resp_sender is
	port
	(
		...
		sync_rx_timestamp_seconds_i : in unsigned(31 downto 0);
		sync_rx_timestamp_nanoseconds_i : in unsigned(31 downto 0);
...
architecture Behavioral of ptpv2_delay_resp_sender is
	-- Constants
	...
	constant UDP_PAYLOAD_LENGTH		: integer := 54;
	...
	begin
		if (falling_edge(tx_clk)) then
			...
			if ((frame_start = '1') and (zframe_start = '0') and (s_SM_Ethernet = s_Idle)) then
				...
				udp_frame(42) <= x"09"; -- 0 majorSdoId + Delay Req
                ...
                udp_frame(74) <= x"03"; -- 32 controlField -- 0x02 for Delay_Resp
				...
				udp_frame(78) <= std_logic_vector(sync_rx_timestamp_seconds_i(31 downto 24)); -- 36 2 originTimestamp seconds 
				udp_frame(79) <= std_logic_vector(sync_rx_timestamp_seconds_i(23 downto 16)); -- 37 3 originTimestamp seconds
				udp_frame(80) <= std_logic_vector(sync_rx_timestamp_seconds_i(15 downto 8)); -- 38 4 originTimestamp seconds
				udp_frame(81) <= std_logic_vector(sync_rx_timestamp_seconds_i(7 downto 0)); -- 39 5 originTimestamp seconds
				udp_frame(82) <= std_logic_vector(sync_rx_timestamp_nanoseconds_i(31 downto 24)); -- 40 0 originTimestamp nanoseconds
				udp_frame(83) <= std_logic_vector(sync_rx_timestamp_nanoseconds_i(23 downto 16)); -- 41 1 originTimestamp nanoseconds
				udp_frame(84) <= std_logic_vector(sync_rx_timestamp_nanoseconds_i(15 downto 8)); -- 42 2 originTimestamp nanoseconds
				udp_frame(85) <= std_logic_vector(sync_rx_timestamp_nanoseconds_i(7 downto 0)); -- 43 3 originTimestamp nanoseconds
