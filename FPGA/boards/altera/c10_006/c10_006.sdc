...
create_clock -name {c10_clk50m} -period 20 -waveform { 0.000 10.665 } [get_ports {c10_clk50m}]

# RMII 50 MHz reference clock from PHY (external, asynchronous to c10_clk12m)
create_clock -name {phy_rmii_ref_clk} -period 20.000 -waveform { 0.000 10.000 } [get_ports {refclk}]
...
set sys_pll_clk0      {soc_top_inst|wb_bridge_top_inst|sysclk_pll_gen_inst|\sysclkgen12:sysclks_altpll_50m_in_inst|altpll_component|auto_generated|pll1|clk[0]}
set sys_pll_clk1      {soc_top_inst|wb_bridge_top_inst|sysclk_pll_gen_inst|\sysclkgen12:sysclks_altpll_50m_in_inst|altpll_component|auto_generated|pll1|clk[1]}
set sys_pll_clk2      {soc_top_inst|wb_bridge_top_inst|sysclk_pll_gen_inst|\sysclkgen12:sysclks_altpll_50m_in_inst|altpll_component|auto_generated|pll1|clk[2]}
...
create_clock -name {spictrl_clk} -period 40.000 [get_ports {spictrl_clk}]

set_input_delay  -clock {spictrl_clk} -max 5 [get_ports {spictrl_mosi spictrl_cs}]
set_input_delay  -clock {spictrl_clk} -min 0 [get_ports {spictrl_mosi spictrl_cs}]
set_output_delay -clock {spictrl_clk} -max 5 [get_ports {spictrl_miso}]
set_output_delay -clock {spictrl_clk} -min 0 [get_ports {spictrl_miso}]

# IRQ to MCU is a level/edge with no critical timing.
set_false_path -from * -to [get_ports {spictrl_irq}]
...
set_false_path -from * -to [get_ports {mdc}]
set_false_path -from * -to [get_ports {mdio}]
set_false_path -from [get_ports {mdio}] -to *
...
set_clock_groups -asynchronous \
    -group [get_clocks [list c10_clk50m $sys_pll_clk0]] \
