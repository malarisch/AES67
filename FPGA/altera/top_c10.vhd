...
SIGNAL	hram_dq :  STD_LOGIC_VECTOR(7 DOWNTO 0);
SIGNAL	hram_rstn :  STD_LOGIC;
SIGNAL	hram_rwds :  STD_LOGIC;
...
PORT MAP(aes67_ctrl_eth_link_up => mac_linkup,
		 ...
		 hyperram_cs_n => hram_cs,
		 hyperram_rst_n => hram_rstn,
