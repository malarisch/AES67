...
##   Audio clocks generated by audioclock_generator (inst: audioclocks):
...
# Audio clocks from audioclock_generator (instance: audioclocks)
...
create_generated_clock -name {clk_256fs} \
    ...
    [get_registers {audioclocks|cnt[0]}]
...
create_generated_clock -name {clk_128fs} \
    ...
    -divide_by 4 \
    -master_clock {audio_mclk} \
    [get_registers {audioclocks|cnt[1]}]
...
create_generated_clock -name {clk_64fs} \
    ...
    -divide_by 8 \
    -master_clock {audio_mclk} \
    [get_registers {audioclocks|cnt[2]}]
...
create_generated_clock -name {fs} \
    ...
    -divide_by 512 \
    -master_clock {audio_mclk} \
    [get_registers {audioclocks|cnt[8]}]
...
create_generated_clock -name {bclk_f} \
    ...
    -invert \
    -master_clock {audio_mclk} \
    [get_registers {audioclocks|bclk_f_r}]
