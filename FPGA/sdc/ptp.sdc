...
set_multicycle_path -setup -end 8 \
    -to [get_registers {*b2v_ptpparser|elapsed_ns*}]
set_multicycle_path -hold  -end 7 \
    -to [get_registers {*b2v_ptpparser|elapsed_ns*}]

set_multicycle_path -setup -end 8 \
    -to [get_registers {*b2v_ptpparser|ns_sum*}]
set_multicycle_path -hold  -end 7 \
    -to [get_registers {*b2v_ptpparser|ns_sum*}]

set_multicycle_path -setup -end 8 \
    -to [get_registers {*b2v_ptpparser|clock_configure_timestamp_nanoseconds_o*}]
set_multicycle_path -hold  -end 7 \
    -to [get_registers {*b2v_ptpparser|clock_configure_timestamp_nanoseconds_o*}]

set_multicycle_path -setup -end 8 \
    -to [get_registers {*b2v_ptpparser|clock_configure_timestamp_seconds_o*}]
set_multicycle_path -hold  -end 7 \
    -to [get_registers {*b2v_ptpparser|clock_configure_timestamp_seconds_o*}]
...
set_multicycle_path -setup -end 2 \
    -to [get_registers {*b2v_servo|pi_input[*]}]
set_multicycle_path -hold  -end 1 \
    -to [get_registers {*b2v_servo|pi_input[*]}]

set_multicycle_path -setup -end 2 \
    -to [get_registers {*b2v_servo|pi_mult_p[*]}]
set_multicycle_path -hold  -end 1 \
    -to [get_registers {*b2v_servo|pi_mult_p[*]}]

set_multicycle_path -setup -end 2 \
    -to [get_registers {*b2v_servo|pi_mult_i[*]}]
set_multicycle_path -hold  -end 1 \
    -to [get_registers {*b2v_servo|pi_mult_i[*]}]

set_multicycle_path -setup -end 2 \
    -to [get_registers {*b2v_servo|pi_proportional[*]}]
set_multicycle_path -hold  -end 1 \
    -to [get_registers {*b2v_servo|pi_proportional[*]}]

set_multicycle_path -setup -end 2 \
    -to [get_registers {*b2v_servo|pi_int_update[*]}]
set_multicycle_path -hold  -end 1 \
    -to [get_registers {*b2v_servo|pi_int_update[*]}]

set_multicycle_path -setup -end 2 \
    -to [get_registers {*b2v_servo|pi_sum_raw[*]}]
set_multicycle_path -hold  -end 1 \
    -to [get_registers {*b2v_servo|pi_sum_raw[*]}]

set_multicycle_path -setup -end 2 \
    -to [get_registers {*b2v_servo|integral_sum[*]}]
set_multicycle_path -hold  -end 1 \
    -to [get_registers {*b2v_servo|integral_sum[*]}]

set_multicycle_path -setup -end 2 \
    -to [get_registers {*b2v_servo|freq_correction[*]}]
set_multicycle_path -hold  -end 1 \
    -to [get_registers {*b2v_servo|freq_correction[*]}]
...
# hold multicycle = 1.
set_multicycle_path -setup -end 2 \
    -to [get_registers {*b2v_wallclock|ppb_adj_reg[*]}]
set_multicycle_path -hold  -end 1 \
    -to [get_registers {*b2v_wallclock|ppb_adj_reg[*]}]
...
# Setup multicycle = 2, hold multicycle = 1.
set_multicycle_path -setup -end 2 \
    -to [get_registers {*b2v_bmc|ann_better_r}]
set_multicycle_path -hold  -end 1 \
    -to [get_registers {*b2v_bmc|ann_better_r}]

set_multicycle_path -setup -end 2 \
    -to [get_registers {*b2v_bmc|ext_beats_self_r}]
set_multicycle_path -hold  -end 1 \
    -to [get_registers {*b2v_bmc|ext_beats_self_r}]
